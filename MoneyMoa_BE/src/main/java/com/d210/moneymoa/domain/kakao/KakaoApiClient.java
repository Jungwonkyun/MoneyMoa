package com.d210.moneymoa.domain.kakao;

import com.d210.moneymoa.domain.oauth.OAuthApiClient;
...
public class KakaoApiClient implements OAuthApiClient {
    ...
    public OAuthInfoResponse requestOauthInfo(String accessToken) {
        ...
        body.add("property_keys", "[\"id\", \"kakao_account.email\", \"kakao_account.profile\"]");
